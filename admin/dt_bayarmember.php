        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <a href="pembayaran/bayar_tambah.php" class="btn btn-primary">Tambah Data Bayar</a><br><br>
                        <table class="datatable-1 table table-striped table-bordered  display"
                                        ...
                                        <?php
                                            include ("../koneksi.php");
                                            $query2 = "SELECT * FROM tb_bayarmember";
                                            $no=1;
											...
											<tr>
												...
												<td> <?php echo "IDR ". number_format($row['jml_bayar'],0,',','.'); ?> </td>
                                                       <td> 
			<a href="layanan/layanan_edit.php?id=<?php echo $row['id_layanan']; ?>" class="btn btn-primary btn-sm"> Edit </a>
			<a href="pembayaran/hapusbayar.php?id=<?php echo $row['id_bayarm']; ?>" class="btn btn-danger btn-sm"> Hapus </a>
		</td>
	</tr>
