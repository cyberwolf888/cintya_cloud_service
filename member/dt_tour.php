        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <a href="tour/tour_tambah.php" class="btn btn-primary">Tambah Data Paket Tour</a><br><br>
                        <table class="datatable-1 table table-striped table-bordered  display"
                                        ...
                                        <?php
											...
											<tr>
                                                ...
                                                <td> Rp. <?php echo number_format($row['harga_tour'],0,',','.') ?> </td>
												<td> <?php echo $row['deskripsi']; ?> </td>
                                                <td> <?php echo $row['gambar']; ?> </td>
                                                <td> <?php echo $row['status']==1?'Aktif':'Suspend'; ?> </td>
                                                       <td>
			<a href="tour/tour_edit.php?id=<?php echo $row['id_tour']; ?>" class="btn btn-primary btn-sm"> Edit </a>
