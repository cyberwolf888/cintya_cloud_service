...
<div id="wrapper">
    ...
    <div id="sidebar-wrapper">
        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                    <h1 class="sub-header">Tambah Data Tour</h1>
                    
                    <form name="tambah" method="post" action="tour_tambahproses.php" class="form-horizontal">
	...
	<div class="form-group">
		...
		<div class="col-md-4">
			<input type="text" class="form-control"  name="harga_tour" class="form-control" required>
		</div>
	</div>
	<div class="form-group">
		<label class="label-control col-md-2">Deskripsi</label>
		<div class="col-md-4">
			<input type="text" class="form-control"  name="deskripsi" class="form-control" required>
		</div>
	</div>
    <div class="form-group">
